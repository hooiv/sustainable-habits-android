...
import com.example.myapplication.features.biometric.BiometricIntegration
...
class BiometricIntegrationViewModel @Inject constructor(
     ...
     */
    fun getCurrentBiometricData(): BiometricData {
        ...
        return BiometricData(
            ...
            mood = coreData.mood,
            activityLevel = ActivityLevel.valueOf(coreData.activityLevel.name)
        )
    }
