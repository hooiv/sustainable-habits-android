...
class NeuralInterfaceViewModel @Inject constructor(
    ...
    private val biometricIntegration: com.example.myapplication.features.biometric.BiometricIntegration,
    private val spatialComputing: com.example.myapplication.features.spatial.SpatialComputing,
    private val voiceAndNlpProcessor: com.example.myapplication.features.voice.VoiceAndNlpProcessor,
    private val quantumVisualizer: com.example.myapplication.features.quantum.QuantumVisualizer
) : ViewModel() {
    ...
    private val _selectedSpatialObject = MutableStateFlow<com.example.myapplication.core.data.model.SpatialObject?>(null)
    val selectedSpatialObject: StateFlow<com.example.myapplication.core.data.model.SpatialObject?> = _selectedSpatialObject.asStateFlow()
     ...
     */
    fun addSpatialObjectForHabit(habit: Habit, position: com.example.myapplication.core.data.model.Offset3D) {
        viewModelScope.launch {
            try {
     ...
     */
    fun getObjectAtScreenPosition(screenPosition: androidx.compose.ui.geometry.Offset): com.example.myapplication.core.data.model.SpatialObject? {
     ...
     */
    fun getActionDescription(action: com.example.myapplication.core.data.model.ReinforcementAction): String {
    ...
    /**
     * Convert habit to spatial object
     */
    private fun convertHabitForSpatial(habit: com.example.myapplication.core.data.model.Habit): com.example.myapplication.core.data.model.SpatialObject {
        return com.example.myapplication.core.data.model.SpatialObject(
            ...
            position = com.example.myapplication.core.data.model.Offset3D(0f, 0f, 0f),
            rotation = com.example.myapplication.core.data.model.Rotation3D(0f, 0f, 0f),
            scale = 1.0f,
            color = try { 
                if (habit.color != null) android.graphics.Color.parseColor(habit.color).toLong() else 0xFFFFFFFF 
    ...
    /**
     * Convert habit completions to spatial objects
     */
    private fun convertHabitCompletionsForSpatial(completions: List<com.example.myapplication.core.data.model.HabitCompletion>): List<com.example.myapplication.core.data.model.SpatialObject> {
        return completions.map { completion ->
            com.example.myapplication.core.data.model.SpatialObject(
                id = completion.id,
                type = com.example.myapplication.core.data.model.SpatialObjectType.ACHIEVEMENT_STAR,
                position = com.example.myapplication.core.data.model.Offset3D(0f, 0f, 0f), 
                rotation = com.example.myapplication.core.data.model.Rotation3D(0f, 0f, 0f),
                scale = 0.5f,
                color = android.graphics.Color.GREEN.toLong(),
                relatedHabitId = completion.habitId,
                label = "Completion"
            )
        }
    }
