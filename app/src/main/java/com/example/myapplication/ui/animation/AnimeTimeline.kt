...
/**
 * Anime.js inspired easing functions for timeline animations
 */
object AnimeTimelineEasing {
...
fun Modifier.animeEntrance(
    ...
    easing: Easing = AnimeTimelineEasing.EaseOutElastic
): Modifier = composed {
...
fun Modifier.animeMorph(
    ...
    duration: Int = 1000,
    easing: Easing = AnimeTimelineEasing.EaseInOutElastic
): Modifier = composed {
